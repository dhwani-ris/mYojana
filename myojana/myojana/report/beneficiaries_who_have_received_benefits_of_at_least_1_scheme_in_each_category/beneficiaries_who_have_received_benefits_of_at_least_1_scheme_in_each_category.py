...
def execute(filters=None):
	...
	columns = [
		{"fieldname": "n", "label": _("No. of beneficiaries"), "fieldtype": "int", "width": 200},
		{"fieldname": "count", "label": _("No. distinct beneficiaries"), "fieldtype": "int", "width": 200},
	]
	...
	milestones = frappe.db.sql(
		"SELECT DISTINCT milestone as milestone FROM `tabScheme` WHERE enabled = 1", as_dict=True
	)
