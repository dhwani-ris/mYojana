...
def send(phoneNo, imgDataUrl):
    ...
    payload = f"channel=whatsapp&source={whatsapp.get('source')}&destination=91{phoneNo}&message={message}&src.name={whatsapp.get('src.name')}"
    headers = {
