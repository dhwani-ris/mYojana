...
def delete_all_child_doc(doctype=None, parent=None, parentfield=None, parenttype=None):
	frappe.db.delete(doctype, {"parent": parent, "parentfield": parentfield, "parenttype": parenttype})
	return True
...
def get_all_child_doc(doctype=None, parent=None, parentfield=None, parenttype=None):
	list = frappe.db.get_list(
		doctype,
		filters={"parent": parent, "parentfield": parentfield, "parenttype": parenttype},
		pluck="fieldname",
		order_by="idx asc",
